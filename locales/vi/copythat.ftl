...
server-hint = Chạy Copy That như một máy chủ tệp không giao diện. Chọn các giao thức cần công khai, đặt địa chỉ và thư mục cần phục vụ, và tùy chọn yêu cầu xác thực.
