...
toast-clipboard-files-detected = क्लिपबोर्ड पर फ़ाइलें — Freally File Manager के ज़रिए कॉपी करने के लिए अपना पेस्ट शॉर्टकट दबाएँ
...
settings-paste-shortcut-hint = Explorer / Finder / Files से कॉपी की गई फ़ाइलों को Freally File Manager के ज़रिए पेस्ट करने के लिए अपने सिस्टम पर कहीं भी यह कॉम्बो दबाएँ। CmdOrCtrl macOS पर Cmd और Windows / Linux पर Ctrl में बदल जाता है।
settings-clipboard-watcher = कॉपी की गई फ़ाइलों के लिए क्लिपबोर्ड पर नज़र रखें
settings-clipboard-watcher-hint = जब क्लिपबोर्ड पर फ़ाइल URL दिखें तो एक टोस्ट दिखाएँ, यह संकेत देते हुए कि आप Freally File Manager के ज़रिए पेस्ट कर सकते हैं। सक्षम रहने पर हर 500 ms पर जाँच करता है।
...
settings-intercept-copy-hint = चालू होने पर, Explorer का Ctrl+C / Ctrl+V Freally File Manager के ज़रिए होकर गुज़रता है। पंजीकरण Phase 14 में आएगा।
...
settings-updater-hint = Freally File Manager दिन में अधिकतम एक बार साइन किए गए अपडेट की जाँच करता है। अपडेट अगली बार ऐप बंद होने पर इंस्टॉल होते हैं।
...
settings-on-locked-hint = "फ़ाइल किसी अन्य प्रोसेस द्वारा उपयोग में है" त्रुटियों को समाप्त करें। Freally File Manager स्रोत वॉल्यूम का स्नैपशॉट लेता है (Windows पर VSS, Linux पर ZFS/Btrfs, macOS पर APFS) और स्नैपशॉट कॉपी से पढ़ता है।
snapshot-prompt-title = यह फ़ाइल किसी अन्य प्रोसेस द्वारा उपयोग में है
snapshot-prompt-body = एक अन्य प्रोग्राम ने { $path } को एक्सक्लूसिव राइट के लिए खोल रखा है। चुनें कि Freally File Manager को इस तथा उसी वॉल्यूम पर ऐसी ही फ़ाइलों को कैसे संभालना चाहिए।
...
snapshot-vss-needs-elevation = VSS स्नैपशॉट से पढ़ने के लिए Administrator अनुमति आवश्यक है। Freally File Manager आपसे इसकी अनुमति माँगेगा।
...
resume-prompt-body = Freally File Manager ने पिछले सत्र से { $count } अधूरे स्थानांतरण पाए। प्रत्येक के साथ क्या करना है चुनें।
...
dropstack-show-tray-icon = Freally File Manager ट्रे आइकन दिखाएँ
...
settings-mount-on-launch-path-placeholder = उदा. C:\Mounts\freally
...
settings-audit-file-path-placeholder = उदा. C:\ProgramData\Freally\audit.log
...
cli-help-tagline = Freally File Manager CLI — CI/CD पाइपलाइनों के लिए बाइट-एग्ज़ैक्ट फ़ाइल कॉपी, सिंक, सत्यापन और ऑडिट।
...
cli-info-shape-recorded = बैंडविड्थ शेप "{ $rate }" दर्ज किया गया; प्रवर्तन freally-shape के ज़रिए जुड़ा हुआ है
...
settings-mobile-pair-active = पेयर-सर्वर सक्रिय — Freally File Manager मोबाइल ऐप से QR स्कैन करें
...
settings-dedup-hint = जब स्रोत और गंतव्य एक वॉल्यूम साझा करते हैं, तो Freally File Manager बाइट्स कॉपी करने के बजाय फ़ाइलसिस्टम स्तर पर फ़ाइलों को क्लोन कर सकता है। Reflink तुरंत और सुरक्षित है; hardlink तेज़ है पर दोनों नाम स्थिति साझा करते हैं।
...
plugin-hint = सैंडबॉक्स्ड WASM प्लगइन Freally File Manager को कस्टम हुक के साथ विस्तृत करते हैं। हर प्लगइन प्रति-कॉल CPU और मेमोरी सीमाओं के तहत चलता है और केवल वही होस्ट क्षमताएँ देखता है जो आप उसे देते हैं।
...
bottleneck-source-io = स्रोत I/O
bottleneck-dest-io = गंतव्य I/O
bottleneck-network = नेटवर्क
bottleneck-antivirus = एंटीवायरस
bottleneck-cpu = CPU
bottleneck-thermal = थर्मल
bottleneck-unknown = अज्ञात
diag-aria = बॉटलनेक: { $cause }
diag-tooltip = { $cause } द्वारा सीमित · { $rate }
diag-spark-aria = पिछले एक मिनट का थ्रूपुट
diag-keeping-up = गति बनाए हुए
diag-label = डायग्नोस्टिक्स

# Phase 48 — server mode + observability (Settings → Server).
settings-tab-server = सर्वर
server-hint = Freally File Manager को बिना इंटरफ़ेस वाले फ़ाइल सर्वर के रूप में चलाएँ। एक्सपोज़ करने के लिए प्रोटोकॉल चुनें, पता और परोसने के लिए फ़ोल्डर सेट करें, और वैकल्पिक रूप से प्रमाणीकरण आवश्यक करें।
server-protocols = प्रोटोकॉल
server-bind-addr = बाइंड पता
server-root = परोसा गया फ़ोल्डर
server-readonly = केवल पढ़ने योग्य (अपलोड और हटाना अस्वीकार करें)
server-auth-mode = प्रमाणीकरण
server-auth-none = कोई नहीं
server-auth-bearer = बेयरर टोकन
server-auth-basic = बेसिक (उपयोगकर्ता नाम + पासवर्ड)
server-auth-token = टोकन
server-auth-user = उपयोगकर्ता नाम
server-auth-password = पासवर्ड
otel-endpoint = OpenTelemetry एंडपॉइंट
webhook-section = Webhooks
webhook-url = Webhook URL
webhook-add = Webhook जोड़ें
webhook-remove = हटाएँ
webhook-empty = कोई webhook कॉन्फ़िगर नहीं किया गया।
webhook-pushover-token = Pushover टोकन
webhook-pushover-user = Pushover उपयोगकर्ता
server-start = सर्वर शुरू करें
server-stop = सर्वर रोकें
server-status-running = { $addr } पर चल रहा है
server-status-stopped = रुका हुआ
