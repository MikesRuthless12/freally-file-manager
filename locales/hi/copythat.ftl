...
server-hint = Copy That को बिना इंटरफ़ेस वाले फ़ाइल सर्वर के रूप में चलाएँ। एक्सपोज़ करने के लिए प्रोटोकॉल चुनें, पता और परोसने के लिए फ़ोल्डर सेट करें, और वैकल्पिक रूप से प्रमाणीकरण आवश्यक करें।
