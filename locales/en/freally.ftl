...
collision-modal-hash-computing = Hashing…
collision-modal-hash-identical = Identical
collision-modal-hash-different = Different
...
settings-mount-on-launch-path-placeholder = e.g. C:\Mounts\freally
...
settings-audit-file-path-placeholder = e.g. C:\ProgramData\Freally\audit.log
...
cli-info-shape-recorded = Bandwidth shape "{ $rate }" recorded; enforcement is plumbed via freally-shape
...
plugin-no-capabilities = (none)
plugin-directory = Location
plugin-install-from-file = Install from file…
plugin-install-from-url = Install from URL…
