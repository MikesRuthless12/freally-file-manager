...
server-hint = Запустите Copy That как файловый сервер без интерфейса. Выберите протоколы для публикации, задайте адрес и папку для раздачи и при необходимости включите аутентификацию.
