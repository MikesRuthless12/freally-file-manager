...
settings-mount-on-launch-path-placeholder = z. B. C:\Mounts\freally
...
settings-audit-file-path-placeholder = z. B. C:\ProgramData\Freally\audit.log
...
cli-info-shape-recorded = Bandbreitenform "{ $rate }" aufgezeichnet; die Durchsetzung erfolgt über freally-shape
...
library-tab-compare = Vergleichen
repo-change-added = Hinzugefügt
repo-change-removed = Entfernt
repo-change-modified = Geändert
repo-change-unchanged = Keine Änderungen
repo-diff-summary = { $added } hinzugefügt · { $removed } entfernt · { $modified } geändert
repo-diff-bytes-added = { $bytes } neu
repo-diff-pick-two = Zwei Snapshots zum Vergleichen auswählen
# Phase 49r — statistics / reports.
library-tab-reports = Berichte
report-growth-title = Speicherwachstum
report-by-kind-title = Nach Art
report-top-files-title = Top-Dateien
report-dedup-ratio = { $pct }% dedupliziert
report-export = Bericht exportieren
report-exported = Bericht gespeichert unter { $path }
report-file-versions = { $n } Versionen
# Phase 49p — pinning / prune.
repo-pin = Anheften
repo-unpin = Lösen
repo-pinned-badge = Angeheftet
repo-prune-title = Bereinigen
repo-prune-keep-last = Neueste behalten
repo-prune-removed = { $n } Snapshots bereinigt
repo-prune-none = Nichts zu bereinigen
...
backup-retention-keep-all = Alle behalten
backup-retention-last = Letzte { $n } behalten
backup-retention-days = Älter als { $days } Tage
backup-retention-gfs = GFS-Rotation
backup-prune-now = Jetzt bereinigen
backup-prune-none = Nichts zu bereinigen
backup-prune-result = { $removed } Snapshots entfernt · { $bytes } freigegeben
# Phase 49f — per-source scheduling.
backup-schedule = Zeitplan
backup-schedule-manual = Manuell
backup-schedule-hourly = Stündlich
backup-schedule-daily = Täglich
backup-schedule-weekly = Wöchentlich
backup-next-run = Nächste Ausführung { $when }
backup-not-scheduled = Nicht geplant
# Phase 49g — source filters.
backup-include-ph = Include-Globs (kommagetrennt)
backup-skip-hidden = Versteckte überspringen
# Phase 49q — notifications.
notify-title = Benachrichtigungen
notify-on-success = Bei Erfolg
notify-on-failure = Bei Fehler
notify-test = Test senden
notify-test-sent = Test an { $n } Ziel(e) gesendet
...
library-compact = Vollständige Kompaktierung
library-compact-started = Kompaktierung gestartet — siehe Aufgaben
# Phase 49h — compression.
library-stat-compression = Durch Komprimierung gespart
storage-compression = Komprimierung
storage-compression-off = Aus
storage-compression-auto = Automatisch (nicht komprimierbare überspringen)
storage-compression-always = Immer
storage-compression-restart = Wird beim nächsten Start angewendet
# Phase 49j — tasks & progress center.
footer-tasks = Aufgaben
tasks-title = Aufgaben
tasks-empty = Noch keine Aufgaben
tasks-running = Läuft
tasks-recent = Kürzlich
tasks-cancel = Abbrechen
task-state-running = Läuft
task-state-completed = Abgeschlossen
task-state-failed = Fehlgeschlagen
task-state-cancelled = Abgebrochen
# Phase 49k — repository setup/connect wizard.
repo-wizard-title = Repository verbinden
repo-wizard-create-tab = Neu erstellen
repo-wizard-connect-tab = Vorhandenes verbinden
repo-field-name = Name
repo-field-path = Speicherort
repo-field-password = Passphrase (optional)
repo-action-create = Erstellen
repo-action-connect = Verbinden
repo-action-browse = Durchsuchen…
...
repo-error-not-found = An diesem Speicherort wurde kein Repository gefunden
repo-error-bad-pass = Falsche Passphrase
repo-note-no-encryption = Die Passphrase regelt nur den Zugriff; Verschlüsselung im Ruhezustand folgt in einer späteren Version
repo-confirm-forget = "{ $name }" aus der Liste entfernen? Deine Daten bleiben auf der Festplatte.
repo-toast-created = Repository "{ $name }" erstellt
repo-toast-connected = Mit "{ $name }" verbunden
repo-toast-pass-changed = Passphrase aktualisiert
# Phase 49l — Sources dashboard.
library-tab-overview = Übersicht
library-source-empty = Noch keine Quellen
library-source-unknown = (nicht angegebene Quelle)
library-source-snapshots = { $n } Snapshots
library-source-latest = Neueste { $when }
# Phase 49n — verify & repair.
repo-action-verify = Prüfen
repo-action-verify-deep = Prüfen (alle Daten lesen)
repo-action-repair = Reparieren…
repo-verify-clean = { $files } Dateien / { $chunks } Blöcke geprüft — keine Schäden
repo-verify-damaged = { $missing } fehlend, { $corrupt } beschädigte Blöcke
repo-repair-confirm = { $n } Snapshots entfernen, die nicht mehr wiederhergestellt werden können?
repo-repair-removed = { $n } beschädigte Snapshots entfernt
...
footer-hash = Hash
hash-inspector-title = Hash-Inspektor
hash-inspector-algo-label = Algorithmus
hash-inspector-add-files = Dateien hinzufügen…
hash-inspector-add-folders = Ordner hinzufügen…
hash-inspector-run = Hashen
hash-inspector-hashing = Wird gehasht…
hash-inspector-clear = Leeren
hash-inspector-close = Schließen
hash-inspector-empty = Dateien oder Ordner auswählen und dann hashen.
hash-inspector-compare-label = Mit einem Hashwert vergleichen
hash-inspector-compare-placeholder = Hashwert, Prüfsummenzeile oder SFV-Zeile einfügen
hash-inspector-compare-invalid = Das sieht nicht nach einem Hashwert aus.
hash-inspector-pair-identical = Die beiden Dateien sind identisch
hash-inspector-pair-different = Die beiden Dateien unterscheiden sich
hash-inspector-truncated = Es werden die ersten { $rows } Dateien angezeigt; der Rest der Auswahl wurde übersprungen.

# FFM-M10 — copy-verification certificate export.
history-export-certificate = Zertifikat
history-export-certificate-hint = Diesen Auftrag als druckbares HTML-/CSV-/JSON-Prüfzertifikat exportieren
certificate-sign-prompt = Zertifikat mit einem privaten ed25519-Schlüssel signieren? Abbrechen exportiert es unsigniert.
certificate-key-picker-title = ed25519-Signaturschlüssel wählen (PKCS#8 PEM)
toast-certificate-exported = Zertifikat exportiert ({ $files } Datei(en))
toast-certificate-exported-signed = Signiertes Zertifikat exportiert ({ $files } Datei(en))

# FFM-M11 — verify-only re-audit.
footer-reaudit = Erneut prüfen
history-reverify = Erneut prüfen
history-reverify-hint = Quelle und Ziel dieses Auftrags neu hashen und Abweichungen melden (schreibt nichts)
reaudit-title = Reine Überprüfung
reaudit-hint = Ein Quell-/Zielpaar neu hashen und Abweichungen melden — schreibt nichts
reaudit-pick-source = Quellordner zum erneuten Prüfen wählen
reaudit-pick-destination = Zielordner zum Vergleichen wählen
reaudit-clean-title = Keine Abweichung — die Bäume stimmen überein
reaudit-drift-title = Abweichung festgestellt
reaudit-summary = { $ok } gleich, { $differs } abweichend, { $missing } fehlend, { $extra } zusätzlich, { $errors } unlesbar ({ $algo })
reaudit-status-differs = Abweichend
reaudit-status-missing = Am Ziel nicht vorhanden
reaudit-status-extra = Nur am Ziel
reaudit-status-error = Unlesbar
reaudit-close = Schließen

# FFM-M12 — cross-filesystem filename doctor.
doctor-title = Dateinamen-Prüfer
doctor-summary = { $flagged } von { $scanned } Namen kann das Ziel ({ $target }) nicht aufnehmen
doctor-issue-reserved-name = Reservierter Gerätename
doctor-issue-illegal-char = Unzulässiges Zeichen
doctor-issue-trailing-dot-space = Punkt oder Leerzeichen am Ende
doctor-issue-component-too-long = Name zu lang
doctor-issue-path-too-long = Pfad zu lang
doctor-issue-case-collision = Groß-/Kleinschreibungs-Kollision
doctor-no-rename = Keine sichere Umbenennung
doctor-apply = { $count } Datei(en) umbenennen
doctor-toast-applied = { $renamed } umbenannt, { $failed } fehlgeschlagen

# FFM-M13 — file-list import as a copy source.
action-import-list = Liste importieren…
filelist-title = Dateiliste importieren
filelist-hint = Eine TXT-/CSV-/JSON-Pfadliste als Quellmenge des Auftrags verwenden
filelist-picker-title = Dateiliste wählen (TXT / CSV / JSON)
filelist-summary = { $found } Datei(en) gefunden, { $missing } fehlen
filelist-missing-header = { $count } aufgeführte Pfad(e) existieren nicht mehr
filelist-preserve-structure = Ordnerstruktur relativ zu einem Stammverzeichnis erhalten
filelist-relative-root-placeholder = Relatives Stammverzeichnis
filelist-toast-queued = { $files } Datei(en) aus der Liste eingereiht
filelist-toast-empty = Diese Liste enthielt keine Pfade

# FFM-M14 — preflight / dry-run report export.
preflight-report-action = Plan exportieren
preflight-report-hint = Diesen Probelauf als HTML / CSV / JSON speichern, bevor etwas kopiert wird
preflight-report-toast = Plan exportiert — { $files } Datei(en), { $findings } Namensbefund(e)

# FFM-M15 — damaged-media salvage.
footer-salvage = Rettung
salvage-title = Von beschädigten Medien retten
salvage-hint = Alles Lesbare aus einer defekten Datei retten, Unlesbares kartieren und beim nächsten Mal nur die Lücken erneut versuchen
salvage-pick-source = Zu rettende Datei wählen
salvage-pick-destination = Wohin die gerettete Kopie geschrieben wird
salvage-toast-complete = Rettung abgeschlossen — { $bytes } Byte(s), keine Lücken
salvage-toast-gaps = { $bytes } Byte(s) gerettet; { $missing } Byte(s) unlesbar in { $gaps } Lücke(n)

# FFM-M16 — whole-job elevated batch with a consent ledger.
history-elevate-batch = Alle erhöhen
history-elevate-batch-hint = Alle Pfade dieses Auftrags mit verweigerter Berechtigung mit einer einzigen Zustimmung erneut versuchen
elevate-batch-none = Keine Pfade mit verweigerter Berechtigung vorhanden
elevate-batch-confirm = Eine Rechteerhöhung für { $count } Pfad(e) gewähren? ({ $skipped } weitere Fehler lassen sich dadurch nicht beheben.) Diese Pfade kopiert der Helfer:
elevate-batch-toast = Erhöhter Stapel — { $copied } kopiert, { $failed } fehlgeschlagen

# ===== Build 3 (FFM-M17..M24) =====

# FFM-M23
err-source-changed = Die Quelldatei wurde während des Lesens geändert
job-source-changed = Quelle während des Kopierens geändert
settings-source-stability-label = Wenn sich eine Quelldatei während des Kopierens ändert
settings-source-stability-description = Prüft Größe und Zeitstempel jeder Quelle nach dem Lesen erneut. Die Überprüfung allein kann dies nicht erkennen.
settings-source-stability-off = Nicht prüfen
settings-source-stability-warn = Warnen und Datei markieren
settings-source-stability-recopy = Datei erneut kopieren
settings-source-stability-fail = Datei als fehlgeschlagen werten

# FFM-M17
err-schedule-id-invalid = Ungültige Zeitplan-Kennung
err-schedule-label-invalid = Ungültiger Zeitplanname
err-schedule-verb-invalid = Ein Zeitplan kann nur kopieren oder verschieben
err-schedule-trigger-invalid = Ungültige Zeitplanzeit
err-schedule-too-many = Zu viele geplante Ausführungen
...
settings-schedule-trigger-hourly = Stündlich
settings-schedule-trigger-daily = Täglich
settings-schedule-trigger-weekly = Wöchentlich
settings-schedule-next-run = Nächste Ausführung
settings-schedule-missed = Verpasste Ausführung schnellstmöglich nachholen
settings-schedule-missed-unsupported = Dieses System holt eine verpasste Ausführung beim Aufwachen immer nach.
settings-schedule-not-installed = In der Systemaufgabenplanung nicht vorhanden

# FFM-M18
err-affinity-too-many = Zu viele Laufwerks-Warteschlangengruppen
err-affinity-name-invalid = Ungültiger Gruppenname
err-affinity-name-duplicate = Eine andere Gruppe verwendet diesen Namen bereits
err-affinity-prefixes-invalid = Eine Gruppe benötigt mindestens einen Ordner
err-affinity-workers-invalid = Ungültige Anzahl an Arbeitsprozessen
settings-affinity-title = Laufwerks-Warteschlangen
settings-affinity-description = Legen Sie selbst fest, welche Ziele eine Übertragungswarteschlange teilen, wenn die Laufwerkserkennung falsch liegt.
settings-affinity-add = Gruppe hinzufügen
settings-affinity-workers = Arbeitsprozesse
...
# FFM-M20
err-favorite-label-invalid = Ungültiger Favoritenname
err-favorite-kind-invalid = Ungültiger Favoritentyp
err-favorite-hotkey-invalid = Ungültiges Tastenkürzel
err-favorite-too-many = Zu viele Favoriten
settings-favorites-title = Favoriten
settings-favorites-empty = Noch keine Favoriten.
settings-favorites-add = Favorit hinzufügen
favorites-recent-title = Zuletzt verwendete Paare
favorites-kind-source = Quelle
favorites-kind-destination = Ziel
...
err-autostart-failed = Die Einstellung für den Start bei der Anmeldung konnte nicht geändert werden
settings-autostart-label = Freally bei der Anmeldung starten
settings-autostart-description = Startet minimiert im Infobereich, damit Shell-Integration, Tastenkürzel, Überwachungen und Zeitpläne ab der Anmeldung aktiv sind.
settings-autostart-unavailable-portable = Im portablen Modus nicht verfügbar — ein Anmeldeeintrag würde auf dieses Wechsellaufwerk verweisen.
settings-autostart-unavailable-platform = Der Start bei der Anmeldung ist auf diesem System nicht verfügbar.
...
settings-tab-queues = Laufwerks-Warteschlangen
settings-tab-favorites = Favoriten
settings-schedule-name = Name
settings-schedule-verb = Aktion
settings-schedule-verb-copy = Kopieren
settings-schedule-verb-move = Verschieben
settings-schedule-manifest = Dateiliste
settings-schedule-destination = Ziel
settings-schedule-when = Läuft
settings-schedule-weekday = Wochentag (0 = Sonntag)
settings-schedule-hour = Stunde
settings-schedule-minute = Minute
settings-affinity-name = Gruppenname
settings-affinity-paths = Ordner
settings-affinity-path-add = Ordner hinzufügen…
settings-favorites-name = Name
settings-favorites-kind = Typ
settings-favorites-path = Ordner
settings-favorites-destination = Ziel
settings-favorites-hotkey = Tastenkürzel
