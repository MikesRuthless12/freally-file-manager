...
# MT
settings-tab-bugreport = Повідомити про помилку

# Phase 51 — end-to-end encrypted collaboration
# MT
settings-tab-collab = Спільна робота
collab-intro = Спільні файли шифруються так, щоб відкрити їх могли лише перелічені тут люди. У кожного свій ключ; спільного пароля немає.
collab-forward-only = Вилучення змінює, хто зможе відкривати файли, зашифровані після цього. Уже прочитані файли повернути不 можна.
collab-members = Учасники
collab-none = Ще нікого не додано.
collab-label = Ім’я
collab-recipient = Його відкритий ключ
collab-add = Додати
collab-remove = Вилучити
collab-generate = Створити ключ для учасника
collab-identity-once = Скопіюйте зараз — показується один раз і це єдиний спосіб відкрити спільні файли:
collab-sas-label = Код підтвердження
collab-sas-hint = Прочитайте код уголос співрозмовнику. Якщо коди збігаються, у вас справжні ключі одне одного.

# Phase 53 — optional decoded video frames (user-supplied ffmpeg)
# MT
merge-heading = Попередній перегляд відео
merge-ffmpeg-hint = Freally може показувати кадри з відео під час порівняння. Для цього потрібен ffmpeg, який не входить у комплект — встановіть його самі, і Freally його використає. Решта працює й без нього.
merge-ffmpeg-enable = Використовувати ffmpeg для кадрів
merge-ffmpeg-path = Шлях до ffmpeg (порожньо — шукати в PATH)
merge-ffmpeg-found = Знайдено
merge-ffmpeg-missing = ffmpeg не знайдено. Порівняння відео все одно працює: замість кадрів показує тривалість, розмір і доріжки.
merge-ffmpeg-disabled = Кадри відео вимкнено. Увімкніть ffmpeg у налаштуваннях, щоб порівнювати зображення.

collab-revoked = Вилучені
collab-no-roster = Списку людей ще немає. Додайте когось, перш ніж ділитися файлами.
collab-admin-key-corrupt = Не вдалося прочитати збережений ключ адміністратора. Можливо, його пошкоджено.

bugreport-intro = Звіти анонімні й ніколи не надсилаються автоматично. Ви самі обираєте вміст і натискаєте «Надіслати» — у нас немає сервера.
bugreport-pending = Очікує звіт про збій із попереднього запуску.
bugreport-description-label = Що сталося?
bugreport-include-crash = Додати звіт про збій
bugreport-preview-label = Показати, що саме буде надіслано
bugreport-send-github = Відкрити issue на GitHub
bugreport-send-gmail = Відкрити Gmail
bugreport-send-email = Відкрити поштову програму
bugreport-dismiss-crash = Відхилити звіт про збій
bugreport-simulate = Змоделювати звіт про збій
...
# MT
power-badge-paused = Призупинено
power-badge-capped = Обмежено
power-badge-tooltip = Політика живлення обмежує передавання. Відкрийте «Налаштування → Живлення».
...
# MT
snapshot-field-label = Ім’я
snapshot-field-description = Опис
snapshot-field-tags = Теги (через кому)
...
# MT
repo-keys-title = Ключі доступу
repo-keys-empty = Цей репозиторій не має парольного захисту.
repo-key-label = Мітка
repo-key-password = Новий пароль
repo-key-auth = Поточний пароль
repo-action-add-key = Додати ключ
repo-action-remove-key = Відкликати
repo-action-recovery = Створити ключ відновлення

# Phase 50h — repository replication (3-2-1)
# MT
repo-action-replicate = Реплікувати до…

# Phase 50g — per-repository pack storage backend
# MT
repo-remote-label = Сховище пакетів
repo-remote-local = Локальний диск
repo-remote-restart = Зміни наберуть чинності після наступного запуску.
repo-remote-unknown = Це віддалене сховище не налаштовано.
repo-remote-not-empty = У цьому репозиторії вже є дані. Сховище пакетів можна вибрати, лише поки він порожній — натомість реплікуйте до нового репозиторію.

repo-replicate-done = Репліковано: скопійовано знімків — { $copied }, вже було — { $skipped }
repo-replicate-same-path = Призначення збігається з вихідним репозиторієм.

repo-recovery-once = Збережіть зараз — показується лише один раз:
...
eula-intro = Ознайомтеся з угодою нижче. Її потрібно прийняти перед використанням Freally File Manager.
eula-scroll-hint = Прокрутіть до кінця, щоб активувати «Приймаю».
eula-thanks = Дякуємо за прочитання.
eula-agree = Приймаю
eula-decline = Відхилити та вийти
eula-error = Не вдалося зберегти прийняття: { $error }

# FFM-M01 — Explorer copy-verb takeover.
settings-intercept-copy-unsupported = Перехоплення копіювання доступне лише у Windows.
settings-intercept-copy-needs-menu = Спершу увімкніть інтеграцію з контекстним меню — обробник копіювання має бути зареєстрований, перш ніж перехоплення зможе взяти керування.
settings-revert-copy-handler = Повернути обробник копіювання Windows
toast-copy-handler-reverted = Повернено обробник копіювання Windows
settings-context-menu-hint = Реєструє або вилучає контекстне меню та обробник копіювання Freally в системі (для користувача, без адміністратора).
paste-chooser-title = Копіювати та вставити
paste-chooser-close = Закрити
paste-chooser-files = { $count } файл(ів) — виберіть призначення
paste-chooser-system-copy = Системне копіювання
paste-chooser-system-move = Системне переміщення
paste-chooser-system-hint = Швидке просте перенесення, без перевірки
paste-chooser-freally-copy = Копіювання Freally
paste-chooser-freally-move = Переміщення Freally
paste-chooser-freally-hint = Перевірене побайтово точне перенесення
paste-chooser-replace-older = Freally — замінити старіші файли
paste-chooser-replace-older-hint = Перевірено; перезаписує лише якщо джерело новіше
paste-chooser-more = Більше опцій…
toast-system-paste-done = Вставлено { $items } елемент(ів)

# FFM-M02 — transactional undo.
undo-title-copy = Скасувати копіювання — вилучити скопійовані файли?
undo-title-move = Скасувати переміщення — повернути файли?
undo-summary = { $ready } з { $total } елементів можна скасувати; решта змінилися, зникли або конфліктують.
undo-action-trash = До смітника
undo-action-move-back = Повернути
undo-status-ready = Готово
undo-status-skip-missing = Відсутній — пропущено
undo-status-skip-changed = Змінено — пропущено
undo-status-conflict = Початковий шлях зайнято
undo-cancel = Скасувати
undo-confirm = Скасувати { $count } елемент(ів)
toast-undo-done = Скасування завершено: { $done } виконано, { $skipped } пропущено, { $failed } невдало
toast-undo-nothing = Нема чого скасовувати
history-undo = Скасувати
history-undo-hint = Обертає це завдання: скопійовані файли йдуть до смітника, переміщені повертаються на початкове місце

# FFM-M03 — trash-aware delete.
menu-trash-source = Видалити джерело до смітника
trash-confirm = Надіслати до смітника?
{ $path }
toast-trash-done = Переміщено до смітника: { $trashed } елемент(ів), { $failed } невдало
settings-safety-confirm-trash = Підтверджувати перед видаленням до смітника
settings-safety-move-to-trash = Надсилати переміщені початкові файли до смітника
settings-safety-move-to-trash-hint = Під час переміщення надсилати джерело до смітника замість видалення — переміщення з можливістю відновлення.

# FFM-M04/M05 — eject + keep-awake.
menu-eject-destination = Витягнути цільовий том
toast-eject-done = Том витягнуто — можна безпечно від'єднати
toast-eject-failed = Не вдалося витягнути: { $error }
settings-power-keep-awake = Не давати комп'ютеру засинати під час завдань
settings-power-keep-awake-hint = Утримує системне блокування (без сну та заставки), доки триває копіювання.

# FFM-M06 — content-aware collision policies.
collision-policy-skip-identical-else-overwrite = Перезаписувати лише за різного вмісту
collision-policy-skip-identical-else-prompt = Пропускати, якщо ідентично, інакше запитати

# FFM-M07 — failed-file ledger + retry.
history-retry-failed = Повторити невдалі
history-retry-failed-hint = Перекопіювати лише файли, що не вдалися в цьому завданні
history-export-failed = Експортувати невдалі
history-export-failed-hint = Зберегти список невдалих файлів як CSV / TXT / JSON
toast-retry-failed-none = Немає невдалих файлів для повтору
toast-retry-failed-queued = Повторно поставлено в чергу { $count } невдалих файлів
toast-failed-exported = Список невдалих експортовано

# FFM-M08 — checksum sidecars.
menu-create-checksums = Створити контрольні суми (SHA-256)
toast-checksums-created = Контрольні суми записано для { $files } файл(ів)
sidecar-verify-clean-title = Усі файли перевірено
sidecar-verify-bad-title = Перевірка контрольних сум не вдалася
sidecar-verify-summary = { $ok } ОК, { $failed } невдало, { $missing } відсутні
...
settings-portable-keychain-warning = Хмарні облікові дані зберігаються в зашифрованому файлі на портативному диску й відкриваються обраною вами парольною фразою — на цей комп’ютер вони не записуються. Якщо забути фразу, збережені дані відновити не вдасться.

# FFM-M21 — portable credential store (age-encrypted file)
# MT
cloud-error-credentials-locked = Хмарні облікові дані заблоковано. Розблокуйте файл облікових даних на цьому диску, щоб скористатися цим бекендом.
cloud-error-credentials-bad-passphrase = Ця парольна фраза не відкриває файл облікових даних.
cloud-error-credentials-empty-passphrase = Введіть парольну фразу.
cloud-error-credentials-not-portable = Ця інсталяція зберігає облікові дані у системному сховищі ключів, тож розблоковувати нічого.
portable-credentials-title = Портативні хмарні облікові дані
portable-credentials-unlock-body = Введіть парольну фразу, що захищає файл облікових даних на цьому диску.
portable-credentials-create-body = Оберіть парольну фразу для захисту хмарних облікових даних на цьому диску. Відновити її неможливо.
portable-credentials-passphrase-label = Парольна фраза
portable-credentials-unlock-action = Розблокувати
portable-credentials-lock-action = Заблокувати
...
remote-account-name = Ім'я облікового запису
remote-service-account = Сервісний обліковий запис
remote-client-id = ID клієнта
remote-secret = Секрет (ключ доступу / пароль / токен)
remote-job-name = Назва завдання
remote-instance-size = Розмір інстансу
remote-iam-role = Роль / ідентичність IAM
pair-always-connect = Завжди підключатися до мобільного застосунку
pair-broker-url = URL брокера PeerJS (порожньо = публічний за замовчуванням)
pair-devices-heading = Спарені пристрої
pair-onboarding-title = Отримайте мобільний застосунок-компаньйон Freally File Manager
pair-onboarding-loading-qr = Завантаження QR-коду…
sanitize-confirm-backup = Підтверджую, що маю резервну копію всіх даних, які хочу зберегти
sanitize-model-mismatch = Назва моделі накопичувача не збігається.
sanitize-trim-heading = TRIM вільного простору
details-avg-speed = Середня швидкість
pair-onboarding-body = Керуйте завданнями копіювання / переміщення / синхронізації / безпечного видалення на комп'ютері з телефона через приватне WebRTC-з'єднання. Відскануйте QR-код нижче камерою телефона, відкрийте посилання встановлення у браузері й торкніться «На головний екран» — магазин застосунків не потрібен.
pair-onboarding-have-app = Застосунок є, спарити зараз
pair-onboarding-later = Можливо, пізніше
pair-no-device-warning = Автопідключення увімкнено, але жоден телефон ще не спарено. Встановіть мобільний PWA Freally File Manager на телефон (відскануйте QR-код нижче камерою), а потім натисніть «Почати спарення», щоб комп'ютер знав, куди підключатися.
pair-desktop-peer-id = Peer-id комп'ютера:
sanitize-probe = Перевірити можливості
sanitize-run = Запустити очищення
sanitize-run-trim = Виконати TRIM вільного простору
