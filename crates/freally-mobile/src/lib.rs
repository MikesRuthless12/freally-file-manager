//! `freally-mobile` — Phase 37 desktop-side mobile companion.
//!
...
//!   `apps/freally-mobile/` (Vite + Svelte 5 + peerjs). Users
...
//!   in `freally-settings::MobileSettings` and the runtime shape
//!   here.
//!
...
//! - `MobileSettings` wired into `freally-settings::Settings`
