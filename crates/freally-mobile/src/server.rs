...
//! lives in `apps/freally-ui/src-tauri/src/mobile_commands.rs`.
...
pub enum RemoteCommand {
    ...
    /// glue lives in `freally-platform` (Phase 37 follow-up); the
...
pub trait RemoteControl: Send + Sync {
    ...
    /// platform syscall lives in `freally-platform`; this trait
