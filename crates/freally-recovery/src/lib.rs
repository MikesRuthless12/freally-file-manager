//! `freally-recovery` — Phase 39 browser-accessible recovery UI.
//!
...
//! use std::sync::Arc;
//! use freally_recovery::{serve, generate_token};
//! use secrecy::SecretString;
//!
//! # async fn demo() -> Result<(), Box<dyn std::error::Error>> {
//! let history = Arc::new(freally_history::History::open_in_memory().await?);
//! let chunks = Arc::new(freally_chunk::ChunkStore::open(
