...
//!   shape of `freally_core::copy_file` / `copy_tree`: caller passes
//!   a `freally_core::CopyControl` for pause / resume / cancel and an mpsc
...
//! use freally_secure_delete::{shred_file, ShredEvent, ShredMethod};
//! use tokio::sync::mpsc;
//!
//! # async fn demo() -> Result<(), freally_secure_delete::ShredError> {
