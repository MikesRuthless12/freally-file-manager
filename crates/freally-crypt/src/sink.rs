...
//! [`freally_core::TransformSink`] over the crypt crate's
...
use freally_core::{CopyError, TransformOutcome, TransformSink};
...
impl std::fmt::Debug for FreallyCryptHook {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("FreallyCryptHook")
...
impl TransformSink for FreallyCryptHook {
    fn transform<'a>(
        &'a self,
        src: PathBuf,
        dst: PathBuf,
...
mod tests {
    ...
    fn hook_will_transform_respects_policy() {
        ...
        let hook_encrypt = FreallyCryptHook::new(
