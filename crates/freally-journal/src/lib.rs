//! `freally-journal` — durable resume journal.
//!
...
//! # Storage
//!
//! Single redb file at `<data-dir>/freally-journal.redb`, sitting
...
//! # Engine wiring
//!
//! [`FreallyJournalSink`] is an `Arc<dyn JournalSink>` from
//! `freally-core` that the engine drops into
...
pub use sink::FreallyJournalSink;
pub use types::{
