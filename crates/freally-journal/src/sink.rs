...
use freally_core::{JournalSink, ResumePlan as CoreResumePlan};
...
#[derive(Debug)]
pub struct FreallyJournalSink {
    journal: Journal,
    job: JobRowId,
    state: Mutex<BatchState>,
}

impl Clone for FreallyJournalSink {
    fn clone(&self) -> Self {
...
impl JournalSink for FreallyJournalSink {
    fn checkpoint(
        &self,
        file_idx: u64,
        dst: &Path,
