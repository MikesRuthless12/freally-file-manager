//! `freally-helper` — privilege-separated elevated worker.
//!
//! Phase 17d's load-bearing piece. The main `freally-ui` process
...
//!
//! The Phase 19b VSS helper (`freally-helper-vss`) is the narrow
