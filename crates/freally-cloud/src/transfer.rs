...
//! async-agnostic [`crate::FreallyCloudSink`] adapter — which is
...
//!
//! ```no_run
//! # async fn demo() -> Result<(), freally_cloud::BackendError> {
//! # use std::sync::Arc;
//! # use freally_cloud::{Backend, BackendConfig, BackendKind, LocalFsConfig, OperatorTarget, make_operator, copy_to_target};
//! let backend = Backend {
...
//! let target: Arc<dyn freally_cloud::CopyTarget> =
