//! Windows COM in-proc shell extension for Freally File Manager v1.0.0.
//!
...
//! verb invokes the `freally` app binary with
...
//!   the module tree.
//! - [`spawn`] — argv composition for the detached `freally`
