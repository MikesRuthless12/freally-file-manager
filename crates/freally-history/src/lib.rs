//! `freally-history` — SQLite persistence for completed jobs.
//!
...
//!
//! ```no_run
//! use freally_history::{History, JobSummary, ItemRow, HistoryFilter};
//! use std::path::PathBuf;
//!
//! # async fn demo() -> Result<(), freally_history::HistoryError> {
