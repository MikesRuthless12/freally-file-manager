...
impl History {
    ...
    /// `%LOCALAPPDATA%\Freally 2026\history.db`. On macOS:
    /// `~/Library/Application Support/com.freally.filemanager/history.db`.
    /// On Linux: `$XDG_DATA_HOME/freally-2026/history.db`
    /// (default `~/.local/share/freally-2026/`).
