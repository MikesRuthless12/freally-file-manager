...
//! `apps/copythat-ui/plugins/organize-by-exif/src/abi.rs` for the
//! authoritative reference docstring; this is a verbatim duplicate
//! so each plugin stays a self-contained, copy-paste-able starting
//! point for third-party authors.
