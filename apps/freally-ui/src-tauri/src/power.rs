...
//!
//! Maps `freally_power::PowerEvent`s received on the AppState's
...
use freally_settings::{PowerPoliciesSettings, PowerRuleChoice, ThermalRuleChoice};
use freally_shape::{ByteRate, Shape};
use serde::Serialize;
...
fn rule_to_power_battery(r: PowerRuleChoice) -> freally_power::BatteryPolicy {
    match r {
        PowerRuleChoice::Continue => freally_power::BatteryPolicy::Continue,
        PowerRuleChoice::Pause => freally_power::BatteryPolicy::Pause,
        PowerRuleChoice::Cap { bytes_per_second } => {
            freally_power::BatteryPolicy::Cap { bytes_per_second }
        }
    }
}

fn rule_to_power_network(r: PowerRuleChoice) -> freally_power::NetworkPolicy {
    match r {
        PowerRuleChoice::Continue => freally_power::NetworkPolicy::Continue,
        PowerRuleChoice::Pause => freally_power::NetworkPolicy::Pause,
        PowerRuleChoice::Cap { bytes_per_second } => {
            freally_power::NetworkPolicy::Cap { bytes_per_second }
        }
    }
}

fn rule_to_presentation(r: PowerRuleChoice) -> freally_power::PresentationPolicy {
    match r {
        PowerRuleChoice::Continue => freally_power::PresentationPolicy::Continue,
        PowerRuleChoice::Pause => freally_power::PresentationPolicy::Pause,
        PowerRuleChoice::Cap { bytes_per_second } => {
            freally_power::PresentationPolicy::Cap { bytes_per_second }
        }
    }
}

fn rule_to_fullscreen(r: PowerRuleChoice) -> freally_power::FullscreenPolicy {
    match r {
        PowerRuleChoice::Continue => freally_power::FullscreenPolicy::Continue,
        PowerRuleChoice::Pause => freally_power::FullscreenPolicy::Pause,
        PowerRuleChoice::Cap { bytes_per_second } => {
            freally_power::FullscreenPolicy::Cap { bytes_per_second }
        }
    }
}

fn rule_to_thermal(r: ThermalRuleChoice) -> freally_power::ThermalPolicy {
    match r {
        ThermalRuleChoice::Continue => freally_power::ThermalPolicy::Continue,
        ThermalRuleChoice::Pause => freally_power::ThermalPolicy::Pause,
        ThermalRuleChoice::CapPercent { percent } => {
            freally_power::ThermalPolicy::CapPercent { percent }
        }
    }
}
...
fn apply_scoped(
    ...
    snap: &freally_settings::Settings,
...
fn parse_thermal_kind(s: &str) -> freally_power::ThermalKind {
    match s {
        "x86-cpuid" => freally_power::ThermalKind::X86Cpuid,
        "os-reported" => freally_power::ThermalKind::OsReported,
        _ => freally_power::ThermalKind::Unknown,
    }
}
