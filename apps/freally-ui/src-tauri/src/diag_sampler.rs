...
//! [`freally_diag::SystemSampler`]) plus the aggregate copy throughput,
//! classifies the dominant bottleneck
//! ([`freally_diag::classify_snapshot`]), and emits [`EVENT_JOB_DIAG`]
...
use freally_diag::{Bottleneck, DiagSnapshot, DiskBusy, SystemSampler, classify_snapshot};
use freally_platform::DiskBusySampler;
use freally_power::ThermalProbe;
use serde::Serialize;
