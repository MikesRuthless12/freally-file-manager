...
// apps/freally-ui/src-tauri/src/ipc.rs. Enum-shaped fields are
 ...
 * Mirrors `freally_core::LockedFilePolicy`.
 */
...
/** Phase 34 — wire form of `freally_settings::AuditSettings`. */
...
/// Wire form of `freally_settings::DndSettings`. Mirrored in
/// `apps/freally-ui/src-tauri/src/ipc.rs`. Governs the Phase 29
